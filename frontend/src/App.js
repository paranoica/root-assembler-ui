...
const RootAssemblerUI = () => {
    ...
    const handleCodeChange = (e) => {
        const newCode = e.target.value; setCode(newCode);
            ...
            <div className="container mx-auto p-4">
                <div className="navbar bg-base-200 rounded-box mb-4">
                    <div className="flex-1">
                        ...
                        <span className="text-xl font-bold">Assembler/Disassembler UI</span>
                    </div>
                    <div className="flex-none gap-2">
                        <div className={`badge badge-lg gap-2 ${status === "Connected" ? "badge-success" : "badge-error"}`}>
                            {status === "Connected" ?
                        ...
                        <button className="btn btn-circle btn-ghost" onClick={() => setDarkMode(!darkMode)}>
...
export default RootAssemblerUI;